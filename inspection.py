...
Store the NYC restaurant inspection results in a table in an SQLite database.
"""
...
next(rows)   #Do not store the first line of the CSV file into the SQLite table.
...
for row in rows:
    #Change row[1] (the INSPECTION_DATE) from a string in the format "YYYY-MM-DD"
    #to an object of class datetime.date.
